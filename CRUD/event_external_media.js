...
const table = 'events_external_medias'
...
// Creat a new user
async function create(event_id, external_media_id){
    const rows = "(event_id, external_media_id)"
    const values = [event_id, external_media_id]
