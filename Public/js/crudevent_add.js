  ...
  if (e.target.id == "test"){
    ...
    switch (target){
      ...
      case 'optionPlace':
        ...
        newChildType = "p"
        break
      case 'optionExternal_media':
        selected_zone = document.getElementById("addedexternal_medias")
        input_value = document.getElementById("external_medias")
        newChildType = "p"
        break
    }
    id_tab = ""
      ...
      newChild.addEventListener('click', (event) => {
        ...
        switch (target){
          ...
          case 'optionPlace':
            ...
            break
          case 'optionExternal_media':
            var selected_zone = document.getElementById("addedexternal_medias")
            break
        }
